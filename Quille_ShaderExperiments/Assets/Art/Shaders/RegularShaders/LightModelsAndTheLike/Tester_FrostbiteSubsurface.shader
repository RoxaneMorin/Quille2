...
Shader"Tester/FrostbiteSubsurface"
{
	Properties {
		_Tint ("Tint", Color) = (1,1,1,1)
		_MainTex ("Albedo", 2D) = "white" {}
        
        _SubsurfaceDistortion ("Subsurface Distortion", Range(0,1)) = 0
        _SubsurfacePower ("Subsurface Power", Range(1, 20)) = 2
    ...
    SubShader{
        ...
        Pass  {
            ...
            float4 FragmentProgram(vertexOutput input) : SV_TARGET
            {
                ...
                float3 subsurface = FrosbiteSubsurfaceScattering(input.normal, viewDir, lightDir, lightColour, _SubsurfaceDistortion, _SubsurfacePower, _SubsurfaceScale, _SubsurfaceColour, _SubsurfaceColourIntensity, _Thickness);
