    ...
    SubShader{
        ...
        Pass  {
            ...
            float4 FragmentProgram(vertexOutput input) : SV_TARGET
            {
                ...
                float3 specular = CircularSpecular(input.normal, viewDir, lightDir, lightColour, _SpecularOffset, _Glossiness, max(1, _Glossiness * 40));
