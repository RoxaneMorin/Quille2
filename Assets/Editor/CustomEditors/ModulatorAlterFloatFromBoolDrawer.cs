...
[CustomPropertyDrawer(typeof(ChecksAndMods.ModulatorAlterFloatFromBool))]
public class ModulatorAlterFloatFromBoolDrawer : PropertyDrawer
{
            ...
            if (targetObject != null)
            {
                ...
                if (modulator != null)
                {
                    ...
                    string labelText = string.Format("Result = (Modulator {0} {1}) ? (Target {2} {3}) : Target",
                        checkSymbolsArithmetic[mainOpIdx],
