...
public class InterestsMenuUtilities : MonoBehaviour
{
    ...
    // CONSTANTS
    public const string InterestSOPath = "ScriptableObjects/Interests/Fields"; 
    public const string InterestDomainSOPath = "ScriptableObjects/Interests/Domains";
    ...
    {
        Quille.InterestDomainSO[] interestDomainSOs = Resources.LoadAll<Quille.InterestDomainSO>(InterestDomainSOPath);
    ...
    {
        Quille.InterestSO[] interestSOs = Resources.LoadAll<Quille.InterestSO>(InterestSOPath);
