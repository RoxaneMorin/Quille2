...
Shader"Tester/EyeVecSubsurface"
{
	Properties {
        ...
        _SubsurfacePower ("Subsurface Power", Range(1, 10)) = 2
        _SubsurfaceScale ("Subsurface Scale", Range(0,5)) = 2
    ...
    SubShader{
        ...
        Pass  {
            ...
            float4 FragmentProgram(vertexOutput input) : SV_TARGET
            {
                ...
                float3 subsurface = EyeVecSubsurfaceScattering(input.normal, viewDir, lightDir, lightColour, _SubsurfaceThreshold, _SubsurfacePower, _SubsurfaceScale, _SubsurfaceColour, _SubsurfaceColourIntensity);
