...
Shader"Tester/WardAnisoSpecular"
{
	Properties {
    ...
    SubShader{
        ...
        Pass  {
            ...
            float4 FragmentProgram(vertexOutput input) : SV_TARGET
            {
                ...
                float3 specular = WardAnisoSpecular(input.normal, input.tangent, input.binormal, viewDir, lightDir, lightColour, _Glossiness, _Anisotropy);
