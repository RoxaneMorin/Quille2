#if !defined(TUTORIAL_LIGHTING_INCLUDED)
#define TUTORIAL_LIGHTING_INCLUDED
...
#include "AutoLight.cginc"
    ...
    UnityLight CreateLight(Interpolators i)
    {
        UnityLight light;
            ...
            // Separate attenuation & colour into their own params inside the struct?
            UNITY_LIGHT_ATTENUATION(attenuation, i, i.worldPos);
            light.color = _LightColor0.rgb * attenuation;
            //light.color = (_LightColor0.a).xxx * attenuation; // Intensity only.
        #endif
    ...
    FragmentOutput FragmentProgram(Interpolators i) : SV_TARGET
    {
        ...
        float4 colour = UNITY_BRDF_PBS(albedo, specularTint, oneMinusReflectivity, GetSmoothness(i), i.normal, viewDir, CreateLight(i), CreateIndirectLight(i, viewDir));
