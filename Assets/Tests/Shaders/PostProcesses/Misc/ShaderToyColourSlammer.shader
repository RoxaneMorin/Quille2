Shader "Hidden/ShaderToy_ColourSlammer"
{
    // https://www.shadertoy.com/view/Mt2SWc
    ...
    float4 Frag(VaryingsDefault i) : SV_Target
    {
        ...
        float4 slammedColour = floor(originalColour * _ColourSlammingPower) / _ColourSlammingPower;
        slammedColour *= _ColourMultiplier;
        
        return slammedColour;
    }
    ENDHLSL
